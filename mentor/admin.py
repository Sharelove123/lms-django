...
from .models import Teacher,Review,Student,Category,Course,CourseCurriculum,Blog,BlogReview,BlogReviewReply
...
@admin.register(BlogReviewReply)
class BlogReviewREplyAdmin(admin.ModelAdmin):
    list_display = ['id']
